...
export function CubicBezierConnectionComponent({
  ...
  const {getPoint, movePointWithConstraints} = useCurveStore()
    ...
    <>
      ...
      <BezierCurvePoint
        ...
        handle={{
          ...
          y: control1.y,
          onDragMove: (e) => {
            movePointWithConstraints(control1.id, e.target.x(), e.target.y());
      ...
      <BezierCurvePoint
        ...
        handle={{
          ...
          y: control2.y,
          onDragMove: (e) => {
            movePointWithConstraints(control2.id, e.target.x(), e.target.y());
            publishUpdatePathEvent();
          },
        }}
      />
